...
export const EXCHANGE_CATALOG = [
  {
    ...
    descZh: "Lite 套餐 · Console 入门与 50 万 Token 额度",
    descEn: "Lite plan · Console essentials and 500K token quota",
  },
  {
    id: "tier-standard",
    cost: 2500,
    labelKey: "exchangeTierStandard" as const,
    category: "tier" as const,
    descZh: "Standard 套餐 · 多模态 Console 与 150 万 Token",
    descEn: "Standard plan · multimodal Console and 1.5M tokens",
  },
  {
    id: "tier-pro",
    cost: 5000,
    ...
    category: "tier" as const,
    descZh: "Pro 套餐 · 专属 API 与 500 万 Token 额度",
    descEn: "Pro plan · dedicated API and 5M token quota",
  },
  {
    id: "tier-max",
    cost: 20000,
    ...
    category: "tier" as const,
    descZh: "Max 套餐 · 虚拟屏、多脑协作与 2000 万 Token",
    descEn: "Max plan · virtual screen, multi-agent, 20M tokens",
  },
  {
    id: "api-qwen",
    cost: 800,
